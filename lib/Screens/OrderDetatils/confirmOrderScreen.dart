...
class ConfirmOrderScreen extends StatelessWidget {
  static const routeName="/ConfirmOrderDetails";
                ...
                InkWell(
                  onTap: (){
                    showDialogOTP(context).then((value) => {
                      showMyDialog(context,text: "تم تسليم الطلب بنجاح واكتمل").then((value) => Navigator.pushReplacementNamed(context, ConfirmReciveOrderScreen.routeName))
                    });
                  },
                  child: Padding(
