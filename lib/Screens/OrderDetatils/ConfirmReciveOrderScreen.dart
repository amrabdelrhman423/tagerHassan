...
class ConfirmReciveOrderScreen extends StatelessWidget {
  static const routeName = "/ConfirmReciveOrderDetails";
  ConfirmReciveOrderScreen({Key? key}) : super(key: key);
          ...
          for (int index = 0; index < detailstitle.length; index++)
            index == 4 || index == 8
                ? Padding(
                    ...
                    child: Container(
                      color:
                          index % 2 == 1 ? Colors.white : HexColor("#F8F8F8"),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            OrderDetailsRow(
                              imageIcon: detailsimagePath[index],
                              title: detailstitle[index],
                              subtitel: detailsSubtitle[index],
                              isUseGoogleMap: true,
                            ),
                          ],
                        ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          width: 2.0, color: const Color(0xfff3f4f5)),
                    ),
                  ),
                  SizedBox(
                    width: 15,
                  ...
                  onTap: () {
                    showDialogOTP(context).then((value) => {
                          showMyDialog(context,
                                  text: "تم تسليم الطلب بنجاح واكتمل")
                              .then((value) => Navigator.pushReplacementNamed(
                                      context,
                                      OrderDetailsRateScreen
                                          .routeName) //Navigator.of(context).pushNamed(routeName)
                                  )
                        });
                  },
                  child: Padding(
                    padding:
                        EdgeInsets.symmetric(horizontal: 0.sp, vertical: 10.sp),
                    child: Container(
                      height: 50.h,
                      decoration: BoxDecoration(
