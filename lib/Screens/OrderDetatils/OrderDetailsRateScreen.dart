...
import 'package:tagerhasan/Widgets/showRatingDialog.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';



class OrderDetailsRateScreen extends StatelessWidget {

  static const routeName="/OrderRateScreen";



  OrderDetailsRateScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        Row(
          ...
          Text(
            'انقر على النجوم لمشاهدة التقييم',
            style: TextStyle(
              fontSize: 15,
